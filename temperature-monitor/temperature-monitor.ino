...
*=============================================================================*/
String cikData = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";  // <-- FILL IN YOUR CIK HERE! (https://portals.exosite.com -> Add Device)
byte macData[] = { 0x00, 0x08, 0xDC, 0x00, 0x00, 0x01 };
IPAddress ip(10, 0, 0, 120); // IP address, may need to change depending on network
